...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 30 May 2025, 12:50:53
...
INSERT INTO `favori` (`id`, `kullanici_id`, `kitap_id`, `tarih`) VALUES
(12, 13, 26, '2025-04-30 11:52:06'),
(14, 13, 31, '2025-04-30 11:52:06'),
(15, 13, 30, '2025-04-30 11:52:06'),
(16, 13, 37, '2025-04-30 11:52:06'),
(17, 13, 68, '2025-04-30 11:52:06'),
(18, 13, 29, '2025-04-30 11:52:06'),
(19, 13, 75, '2025-04-30 11:52:06'),
(20, 13, 32, '2025-04-30 11:52:06'),
(21, 48, 71, '2025-04-30 11:52:06'),
(22, 47, 9, '2025-04-30 11:52:06'),
(23, 47, 11, '2025-04-30 11:52:06'),
(24, 48, 47, '2025-04-30 11:52:06'),
(25, 47, 71, '2025-04-30 11:52:06'),
(26, 47, 26, '2025-04-30 11:52:06'),
(27, 47, 74, '2025-04-30 11:52:06'),
(29, 48, 75, '2025-04-30 11:52:06'),
(31, 47, 75, '2025-05-27 20:03:53'),
(38, 47, 72, '2025-05-29 10:36:56');
...
(142, 47, 75, '2025-04-06', '2025-04-26', '2025-04-06', 0),
(143, 47, 9, '2025-04-07', '2025-04-27', '2025-04-08', 0),
(144, 48, 47, '2025-04-08', '2025-04-28', '2025-04-08', 0),
(145, 47, 75, '2025-04-08', '2025-04-28', '2025-04-29', 0),
(146, 47, 72, '2025-04-28', '2025-05-18', '2025-04-28', 0),
(147, 47, 75, '2025-04-29', '2025-05-19', '2025-04-29', 0),
(148, 47, 74, '2025-04-30', '2025-05-20', '2025-04-30', 0),
(149, 47, 75, '2025-04-30', '2025-05-20', '2025-05-24', 0),
(150, 47, 74, '2025-04-30', '2025-05-20', '2025-04-30', 0),
(151, 47, 74, '2025-04-30', '2025-05-20', '2025-04-30', 0);
...
CREATE TABLE `kitap` (
  ...
  `ucret` decimal(10,2) DEFAULT 10.00,
  `sesli_ozet` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(47, 'ahmet', 'berke', 'ahmet123@gmail.com', '1234', '2025-05-28', 0),
(48, 'Alper', 'Bilğin', 'alper123@gmail.com', '1234', '2025-04-07', 0);
...
INSERT INTO `yorumlar` (`id`, `kitap_id`, `kullanici_id`, `yorum_metni`, `eklenme_tarihi`) VALUES
(6, 75, 47, 'Süper kitap !', '2025-04-06 19:29:13'),
(14, 47, 48, 'Süper kitap', '2025-04-08 07:17:01'),
(15, 75, 47, 'dasdadad', '2025-04-29 23:12:34'),
(16, 77, 47, 'Mükemmel kitap', '2025-05-27 18:07:26'),
(17, 73, 47, 'çok güzel kitap', '2025-05-29 07:36:46');
...
--
ALTER TABLE `yorumlar`
  ADD CONSTRAINT `yorumlar_ibfk_1` FOREIGN KEY (`kitap_id`) REFERENCES `kitap` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `yorumlar_ibfk_2` FOREIGN KEY (`kullanici_id`) REFERENCES `kullanici` (`id`) ON DELETE CASCADE;
COMMIT;
